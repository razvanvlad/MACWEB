...
import slider_img from '@/assets/img/others/roadmap.png';
                            ...
                            <div className="row justify-content-between">
                                <div className="col-lg-6">
                                    <div className="slider__content">
                                        <h6 className="sub-title wow fadeInUp" data-wow-delay=".2s">QUEST BEGINS!</h6>
                                        <h2 className="title wow fadeInUp" data-wow-delay=".5s">Pixel Path</h2>
                                        <p className="wow fadeInUp" data-wow-delay=".8s">roadmap</p>
                                        <div className="slider__btn wow fadeInUp" data-wow-delay="1.2s">
                                            <Link href="/services" className="tg-btn-1"><span>Check now</span></Link>
                                        </div>
                                    </div>
                                </div>
