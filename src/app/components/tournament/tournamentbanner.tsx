...
import slider_img from '@/assets/img/others/breadcrumb_img01.png';
                            ...
                            <div className="row justify-content-between">
                                <div className="col-lg-6">
                                    <div className="slider__content">
                                        <h6 className="sub-title wow fadeInUp" data-wow-delay=".2s">VICTORY CALLS!</h6>
                                        <h2 className="title wow fadeInUp" data-wow-delay=".5s">PIXEL PLAYOFFS</h2>
                                        <p className="wow fadeInUp" data-wow-delay=".8s">TOURNAMENT & LEADERBOARD</p>
                                        <div className="slider__btn wow fadeInUp" data-wow-delay="1.2s">
                                            <Link href="#" className="tg-btn-1"><span>coming soon</span></Link>
                                        </div>
                                    </div>
                                </div>
