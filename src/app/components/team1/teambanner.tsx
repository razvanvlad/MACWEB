...
import slider_img from '@/assets/img/others/teambanner.png';
                            ...
                            <div className="row justify-content-between">
                                <div className="col-lg-6">
                                    <div className="slider__content">
                                        <h6 className="sub-title wow fadeInUp" data-wow-delay=".2s">WE ARE ONE!</h6>
                                        <h2 className="title wow fadeInUp" data-wow-delay=".5s">BIT BRAINS</h2>
                                        <p className="wow fadeInUp" data-wow-delay=".8s">team</p>
                                        <div className="slider__btn wow fadeInUp" data-wow-delay="1.2s">
                                            <Link href="/about" className="tg-btn-1"><span>Meet us</span></Link>
                                        </div>
                                    </div>
                                </div>
