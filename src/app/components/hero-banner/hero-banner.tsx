                    ...
                    <div className="row justify-content-between">
                        <div className="col-lg-6">
                            <div className="slider__content">
                                <h6 className="sub-title wow fadeInUp" data-wow-delay=".2s">Game on!</h6>
                                <h2 className="title wow fadeInUp" data-wow-delay=".5s">Welcome</h2>
                                <p className="wow fadeInUp" data-wow-delay=".8s">to the playground</p>
