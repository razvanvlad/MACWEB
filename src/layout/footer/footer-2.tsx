                    ...
                    <div className="col-md-4 col-sm-7 order-1 order-md-0">
                        <div className="footer-el-widget">
                            ...
                            <ul className="list-wrap">
                                <li><Link href="tel:123">+407399127879</Link></li>
                                <li><Link href="mailto:info@exemple.com">contact@metaarcadeclub.com</Link></li>
                ...
                <div className="row align-items-center">
                    <div className="col-lg-6">
                        <div className="copyright__text text-center text-lg-start">
                            <p>Copyright © {new Date().getFullYear()} - All Rights Reserved By <span>Meta Arcade Club</span></p>
                        </div>
                    </div>
                    <div className="col-lg-6">
